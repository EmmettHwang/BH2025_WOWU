...
## 📌 버전 정보
- **현재 버전**: v4.1.202601140735
- **최종 업데이트**: 2026년 01월 14일 07시 35분
- **버전 형식**: 메이저.마이너.날짜시간 (예: 4.1.202601140735)

## 🎉 최근 업데이트 (v4.1.202601140735)

### 🎯 개선: DB 초기화 체크박스 방식으로 변경
- **맞춤형 초기화 옵션**
  - 강사 정보 삭제 체크박스 (Root 계정은 항상 유지)
  - 백업 파일 삭제 체크박스
  - 과정 정보 삭제 체크박스
  - 원하는 항목만 선택해서 삭제 가능
