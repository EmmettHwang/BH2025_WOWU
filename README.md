...
## 📌 버전 정보
- **현재 버전**: v3.109.202601140725
- **최종 업데이트**: 2026년 01월 14일 07시 25분
- **버전 형식**: 메이저.마이너.날짜시간 (예: 3.109.202601140725)

## 🎉 최근 업데이트 (v3.109.202601140725)

### 🔧 개선: 완전 초기화 시 Root 계정 제외한 모든 강사 정보 삭제
- **완전 초기화 옵션 강화**
  - Root 계정을 제외한 모든 강사 정보 삭제
  - instructor_codes 테이블: Root 제외하고 삭제
  - instructors 테이블: 전체 삭제
  - courses 테이블: 전체 삭제
  - 시스템 설정과 Root 계정만 유지
